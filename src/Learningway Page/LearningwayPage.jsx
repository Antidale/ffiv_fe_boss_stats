...
const Learningway = () => (
    <article className='mx-auto max-w-6/10'>
        ...
        <section className='py-3'>
            ...
            <p className='text-lg text-center border-slate-400 rounded-sm border-2 border-white max-w-1/6 my-3 shadow-md outline outline-black bg-darkblue text-white'><a href="/public/learningway_seed_one.html">Get the seed</a></p>

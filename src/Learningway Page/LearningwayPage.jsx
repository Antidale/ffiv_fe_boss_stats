...
const Learningway = () => {
    ...
    return (
        <article className='mx-auto max-w-6/10'>
            <h1 className='text-4xl text-center p-3 bg-darkblue text-white border-white rounded-lg border-2 max-w-7/8 mx-auto my-3 outline outline-black shadow-lg wrap-anywhere'>Learningway</h1>

...
const Navigation = () => (
	<nav>
		<div className='items-center justify-center p-6 mx-auto text-gray-200 text-2xl font-semibold'>
			...
			<NavLink className='border-b-2 border-transparent hover:text-gray-800 dark:hover:text-gray-200 hover:border-blue-600 mx-1.5 sm:mx-6' to="/tournaments/">Tournaments</NavLink>
